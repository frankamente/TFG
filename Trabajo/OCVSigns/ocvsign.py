...
while True:
	...
	images = ("Original", recorte), ("Template1", template1), ("Template2", template2)
	...
	# compare the images
	compare_images(recorte, recorte, "Original vs. Original")
	compare_images(recorte, template1, "Original vs. Template1")
	compare_images(recorte, template2, "Original vs. Template2")
